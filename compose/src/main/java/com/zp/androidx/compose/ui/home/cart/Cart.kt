...
package com.zp.androidx.compose.ui.home.cart
    ...
    ConstraintLayout(
        ...
        IconButton(
            ...
            Icon(
                ...
                tint = PlayTheme.colors.iconSecondary,
...
private fun CheckoutBar(modifier: Modifier = Modifier) {
    Column(
        modifier.background(
            PlayTheme.colors.uiBackground.copy(alpha = AlphaNearOpaque)
        )
    ) {
        PlayDivider()
        Row {
