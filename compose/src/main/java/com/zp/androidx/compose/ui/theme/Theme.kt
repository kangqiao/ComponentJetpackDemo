...
private val DarkColorPalette = PlayColors(
    brand = Shadow1,
...
private val LightColorPalette = PlayColors(
    brand = Shadow5,
...
object PlayTheme {
    val colors: PlayColors
        @Composable
        get() = LocalPlayColors.current
}
...
fun ProvidePlayColors(
    ...
    CompositionLocalProvider(LocalPlayColors provides colorPalette, content = content)
}

private val LocalPlayColors = staticCompositionLocalOf<PlayColors> {
