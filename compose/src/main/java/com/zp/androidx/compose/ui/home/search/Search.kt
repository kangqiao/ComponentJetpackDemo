...
package com.zp.androidx.compose.ui.home.search
...
import com.zp.androidx.compose.model.SearchCategoryCollection
import com.zp.androidx.compose.model.SearchRepo
import com.zp.androidx.compose.model.SearchSuggestionGroup
...
private fun SearchBar(
    ...
    PlaySurface(
        color = PlayTheme.colors.uiFloated,
            ...
            Row(
                ...
                if (searchFocused) {
                    IconButton(onClick = onClearQuery) {
                        Icon(
                            ...
                            tint = PlayTheme.colors.iconPrimary,
                ...
                if (searching) {
                    CircularProgressIndicator(
                        color = PlayTheme.colors.iconPrimary,
                        modifier = Modifier
...
private fun SearchHint() {
    Row(
        ...
        Icon(
            ...
            tint = PlayTheme.colors.textHelp,
            contentDescription = stringResource(R.string.label_search)
        )
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.search_Play),
