            ...
            IconButton(onClick = { /* todo */ }) {
                Icon(
                    ...
                    modifier = Modifier.diagonalGradientBorder(
                        colors = PlayTheme.colors.interactiveSecondary,
                        shape = CircleShape
                    )
                )
            }
...
fun FilterChip(
    ...
    val backgroundColor by animateColorAsState(
        if (selected) PlayTheme.colors.brand else PlayTheme.colors.uiBackground
    )
    ...
    val textColor by animateColorAsState(
        if (selected) PlayTheme.colors.textInteractive else PlayTheme.colors.textSecondary
    )
    PlaySurface(
        modifier = modifier
            .height(28.dp)
